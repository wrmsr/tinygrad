...
class RawDiskBuffer(RawBufferMapped):
    ...
    def reshape(self, arg):
        return RawDiskBuffer(self.size, self.dtype, buf=self._buffer(), shape=arg)
...
disk_fxn_for_op: Dict[Op, Callable] = {
    ...
    MovementOps.RESHAPE: RawDiskBuffer.reshape,
    MovementOps.SHRINK: RawDiskBuffer.shrink,
}
