...
def compile(dat, output_fn):
    ...
    input_shapes = {inp.name: tuple(x.dim_value for x in inp.type.tensor_type.shape.dim) for inp in
    ...
    if FLOAT16 == 0:
        try:
            ...
            print(thneed_out, torch_out, "mse", np.sum((thneed_out - torch_out) ** 2), "max err",
